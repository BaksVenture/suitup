...
DATABASES = {
    'default': {
        ...
        'NAME': 'suitup',                      # Or path to database file if using sqlite3.
        'USER': 'suitup',                      # Not used with sqlite3.
        'PASSWORD': 'suitup',                  # Not used with sqlite3.
...
SECRET_KEY = '4v@0&wc$w81i#@2g%vqeh^ya_(mo!j-0+yjrp_ns9!4s_x%1j8'
